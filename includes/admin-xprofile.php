...
add_action('admin_menu', function() {
	...
	$page_hook = add_users_page( _x( 'BuddyPress Extended Profile translation', 'admin page title', 'bpxpt' ), 'XProfile translation', 'manage_options', 'xprofile-translation', 'bpxpt_admin_display_xprofile_translation_page' );
...
function bpxpt_admin_display_xprofile_translation_page() {
	...
	echo '<form method="post" action="users.php?page=xprofile-translation&save=1">';
		...
		echo '<p class="submit"><input type="submit" class="button-primary" value="' . _x( 'Save Changes', 'admin save', 'bpxpt' ) . '" /></p>';
